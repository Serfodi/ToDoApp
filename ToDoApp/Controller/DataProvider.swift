...
extension DataProvider: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case .todo:
            ...
            NotificationCenter.default.post(name: NSNotification.Name("DidSelectRownotification"), object: self, userInfo: ["task": task])
        case .done: break
        }
    }
...
extension DataProvider: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        ...
        switch section {
        case .todo:  taskManager.chekTask(at: indexPath.row)
        case .done: taskManager.unchekTask(at: indexPath.row)
        }
